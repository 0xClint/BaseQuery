...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <span className="absolute top-3 left-3 flex gap-4">
        <Star1
          className="text-main dark:text-blue-500"
          size={150}
          stroke="black"
          strokeWidth={2}
        />
      ...
      <span className="absolute bottom-3 right-3 flex gap-4">
        <Star1
          className="text-main dark:text-blue-500 translate-x-[332px] -translate-y-[160px]"
          size={150}
          stroke="black"
          strokeWidth={2}
        />
      ...
      <form>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-xl font-bold">Welcome to BaseQuery</h1>
          </div>
          <div className="">
            <Button
              // variant="outline"
